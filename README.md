...
```bash
npm install
npm test          # 验收测试全量（222 项：核心 + 不变量 + 加固 + SDK/MCP/declared/考场/网关/contingency/判官锚点；13 项 PG 验收未设 POTHOS_PG_URL 时自动跳过）
